...
* refactor ([2f00c9e](https://github.com/lokalise/i18n-ally/commit/2f00c9e6014e1dd2717b3fc516ced4989e119845))
...
* change display name to "i18n Ally" ([cab39ec](https://github.com/lokalise/i18n-ally/commit/cab39ec6391b7dc8153449fea78c6be57c9dc553))
...
* update badges ([464b5a9](https://github.com/lokalise/i18n-ally/commit/464b5a90203acb00689520810e50ef97986b5b40))
...
* update readme ([6e56de1](https://github.com/lokalise/i18n-ally/commit/6e56de1333c319eb31309201be57d02b6180656c))
...
* extract key reg to frameworks ([41e3239](https://github.com/lokalise/i18n-ally/commit/41e323910b669cf0c58f40954014aa67946e1bdb))
...
* rename ([efe60e1](https://github.com/lokalise/i18n-ally/commit/efe60e1d53596a7e282a858b15263385aa654cf5))
...
* "collapse all" button ([8153666](https://github.com/lokalise/i18n-ally/commit/8153666d8faf3830b7168ec11b1769772767b2d1))
* "set as display language" contextmenu ([608fc93](https://github.com/lokalise/i18n-ally/commit/608fc930922ac408d9f3ed4fa108d672a4482687))
* {ext} for path matcher ([7269ad1](https://github.com/lokalise/i18n-ally/commit/7269ad15017bf4f5c0d20b9a5f44bcb069c1ac47))
* `.js` parser ([b538d45](https://github.com/lokalise/i18n-ally/commit/b538d45d3090a150ae8e3eea9b33ee1baad96206))
* `localesPaths` config now also accept glob pattern ([f4dfcdd](https://github.com/lokalise/i18n-ally/commit/f4dfcdd74a46fdaf0ae160820169e296c2039789))
* 初始化向导 guide ([806dabc](https://github.com/lokalise/i18n-ally/commit/806dabc2de7343da341bfbc9b2f95d26400d79ed))
* 翻译接口，多接口尝试翻译 ([9fbe455](https://github.com/lokalise/i18n-ally/commit/9fbe455451f062d9f98c13464aa2a31e970524f9))
* 默认key, 默认选择后面的随机数方便修改 ([5a31252](https://github.com/lokalise/i18n-ally/commit/5a31252ad59a580c4f73faf71cd1cbbd939ba17f))
* 默认key，只默认2层的路径目录 ([d12cb07](https://github.com/lokalise/i18n-ally/commit/d12cb07f954056cd3e802de193103a2c31a5c25a))
* 如果提取为 i18n，删除前后的"'字符 ([cad1c9d](https://github.com/lokalise/i18n-ally/commit/cad1c9db361bcf723a09d23fee88d33774382c8b))
* 提供默认key ([cba6767](https://github.com/lokalise/i18n-ally/commit/cba67674cebde84e2b013fd032518590fdd99ba1))
* 提取文案翻译 ([e93ec24](https://github.com/lokalise/i18n-ally/commit/e93ec2458e81ca42b61522512a7c621e43e10612))
* 增加$te支持 ([b409e92](https://github.com/lokalise/i18n-ally/commit/b409e9287a1f89d01a93c7a6698f5c7c7757a5d2))
* 支持 $tc 识别 ([63c87cb](https://github.com/lokalise/i18n-ally/commit/63c87cb39b81649c6ed9e9371b6b7cd589db559b))
* 支持 js 和 ts ([2b2ca04](https://github.com/lokalise/i18n-ally/commit/2b2ca047e342b716b38c9f7d767ff4a852f1a890))
* 支持不同的目录结构识别&优化初始化的交互 ([e7886d8](https://github.com/lokalise/i18n-ally/commit/e7886d884e089e15f44a6f844f3ab872a021bca9))
* 支持多行提示 ([bdf9b9a](https://github.com/lokalise/i18n-ally/commit/bdf9b9a0d21c9c5267edeceddcfedfb2904bd9a9))
* 支持在 key 旁边显示中文注释 ([cbe218e](https://github.com/lokalise/i18n-ally/commit/cbe218eb60caec2d41ad80264dc916e2e0caf4d4))
* 自动提示 ([4d54eaf](https://github.com/lokalise/i18n-ally/commit/4d54eaf18b0d63b5112fff907d1c676b0ef53f91))
* 自动完成 ([2943717](https://github.com/lokalise/i18n-ally/commit/2943717b62deda672e2fe0a6f7b3ff6879f00dca))
* able rename keys and remove keys ([2f99d63](https://github.com/lokalise/i18n-ally/commit/2f99d63a4e572b4407e7195952c4c98090ac05b2))
...
* add "goto" button for hover ([079fe1b](https://github.com/lokalise/i18n-ally/commit/079fe1bea949005d92b610204473883f3995cb5e))
* add {fileName} variable support for config.keyPrefix ([#385](https://github.com/lokalise/i18n-ally/issues/385)) ([992b870](https://github.com/lokalise/i18n-ally/commit/992b870f8b48cb1572e459f6ac4fc0037d20f018))
...
* add `i18next-shopify` framework ([#970](https://github.com/lokalise/i18n-ally/issues/970)) ([652b827](https://github.com/lokalise/i18n-ally/commit/652b827d5f2e0413eb8f10d5b2fcc4b29e804262))
...
* Add 2 new options to targetPickingStrategy ([#312](https://github.com/lokalise/i18n-ally/issues/312)) ([641c637](https://github.com/lokalise/i18n-ally/commit/641c6377dc81940324b1a7c9b1751a3b2424adee))
* add a configuration option `sourceLocale` ([1330b9a](https://github.com/lokalise/i18n-ally/commit/1330b9a602e8539372309a7f491f7904610fb0b4))
...
* add an config to turn off annotations ([22ffdf8](https://github.com/lokalise/i18n-ally/commit/22ffdf86bc50cd06776e81842c621c0d66b5cfbd))
...
* add config to force enable this extension (advanced) ([26bd36a](https://github.com/lokalise/i18n-ally/commit/26bd36aff687edae8fc197a5113b7295fdcdc53c))
* add DeepL translate engine ([#452](https://github.com/lokalise/i18n-ally/issues/452)) ([d6e7adc](https://github.com/lokalise/i18n-ally/commit/d6e7adc1eba745b2f67ed517025216bcee623ccb))
...
* add extract.keyMaxLength option ([#405](https://github.com/lokalise/i18n-ally/issues/405)) ([5ddae59](https://github.com/lokalise/i18n-ally/commit/5ddae59ef698d493686cd09d1df793bdc0e5c925))
...
* add fluter_i18n text widget shorthand ([#420](https://github.com/lokalise/i18n-ally/issues/420)) ([59a369c](https://github.com/lokalise/i18n-ally/commit/59a369c7ca762f07116055176f76be1996c98a17))
...
* add icons ([7e86682](https://github.com/lokalise/i18n-ally/commit/7e8668231714ea5ac5bc54f8b36a0f1ba6040c9e))
* add ini parser ([b07bd80](https://github.com/lokalise/i18n-ally/commit/b07bd8093af6fd49b02552b5e98e4ecf40f960f4))
...
* add react-i18next framework support ([3e5ee9c](https://github.com/lokalise/i18n-ally/commit/3e5ee9c4a91ac165e708e05b9484973a154e76fb))
* add rename key icon in Editor UI, resolve [#335](https://github.com/lokalise/i18n-ally/issues/335) ([616e62a](https://github.com/lokalise/i18n-ally/commit/616e62ae1737d8fc8f5e186fa090bf6c59662664))
* add support for `vuex-i18n` and `vue-i18next` ([769cce0](https://github.com/lokalise/i18n-ally/commit/769cce0cd526dcc784d19fecaaa573519465e98a))
...
* add support for react-intl ([6e56515](https://github.com/lokalise/i18n-ally/commit/6e565152849e81f0ae60f1411f7b39f8d17f6bdf))
* add ts locales support ([d7e152b](https://github.com/lokalise/i18n-ally/commit/d7e152b348e186d16fcabcbc8bfa645b8f2f9772))
* add vite-plugin-vue-i18n in framework detection ([#782](https://github.com/lokalise/i18n-ally/issues/782)) ([6815d55](https://github.com/lokalise/i18n-ally/commit/6815d554046e2657b9e02c452f8f118d641befdb)), closes [#751](https://github.com/lokalise/i18n-ally/issues/751)
...
* added keypath autocompletion ([#367](https://github.com/lokalise/i18n-ally/issues/367)) ([76d31b4](https://github.com/lokalise/i18n-ally/commit/76d31b45f8ab38c55db9872fce89cb1aac6a007d))
* adding new `scopeRangeRegex` config to the custom framework ([#926](https://github.com/lokalise/i18n-ally/issues/926)) ([ff7417c](https://github.com/lokalise/i18n-ally/commit/ff7417c7d963f3c989009e071ea63494202b5ffe))
* allow frameworks to set preferred settings ([31e3d2e](https://github.com/lokalise/i18n-ally/commit/31e3d2e0e6b885ac092ec7d15bd95f5938b7d760))
* allow to change annotation color via settings ([ee5efda](https://github.com/lokalise/i18n-ally/commit/ee5efdadf09507c15fac0b313aa4adc1a4a363f4))
...
* allowing flatten scope, [#184](https://github.com/lokalise/i18n-ally/issues/184) [#194](https://github.com/lokalise/i18n-ally/issues/194) ([3581f76](https://github.com/lokalise/i18n-ally/commit/3581f76aab8b131412a7953fdd25ff48f956fb65))
* allows to insert key when the selection is empty, resolves [#378](https://github.com/lokalise/i18n-ally/issues/378) ([3d75677](https://github.com/lokalise/i18n-ally/commit/3d75677988b692af0b63a87fdc50cdbe2cad9550))
* annotation fallback ([d3201bc](https://github.com/lokalise/i18n-ally/commit/d3201bc2a96b6dbe91c482725dd00945418c7d24))
* annotation for "Component interpolation" ([f16cabe](https://github.com/lokalise/i18n-ally/commit/f16cabe8aed55cc5d1a4ffdc0e185e0c003d3275))
* annotation in place ([1447649](https://github.com/lokalise/i18n-ally/commit/144764973e999a34c4e364a9fd0f8cbbace07677))
* auto-completion now listing all keys when starting empty ([149f959](https://github.com/lokalise/i18n-ally/commit/149f9593ddd27ffeff8afa769ebf4a283517f356))
...
* basic review ([e81fd67](https://github.com/lokalise/i18n-ally/commit/e81fd67658cd3c4ef3d8ca5efafd6c64bbcda661))
* basic review ([1a0b2f4](https://github.com/lokalise/i18n-ally/commit/1a0b2f45a8ccf6fb36c76e74fe08f29f0403973d))
* basic webview editor ([836f604](https://github.com/lokalise/i18n-ally/commit/836f604b63040d238d747d05c242c4846d9226e1))
* better extrat prompt ([1c8a33f](https://github.com/lokalise/i18n-ally/commit/1c8a33fc511ac9f477af70a5f09738a736cf7683))
* bring back "replace_with", close [#398](https://github.com/lokalise/i18n-ally/issues/398) ([25015e9](https://github.com/lokalise/i18n-ally/commit/25015e9a18dc990aeec223993f6af023c6004e7a))
* change default language to 'en' ([8a30812](https://github.com/lokalise/i18n-ally/commit/8a308120dd487096b03368a49b9979e9932fd0b1))
...
* collection support, close [#62](https://github.com/lokalise/i18n-ally/issues/62) ([deff789](https://github.com/lokalise/i18n-ally/commit/deff789bdf58d24404dfc2180546d7b2f37fd66d))
* command to fulfill missing keys with empty string ([f78eb9f](https://github.com/lokalise/i18n-ally/commit/f78eb9fae353c4bceae7e644a1efa0a5171ed3fe))
* **command:** new command "insert key" ([bc5ce41](https://github.com/lokalise/i18n-ally/commit/bc5ce41140615c6a177c80299a25c8b360c5db3b))
* config for "annotation_max_length" ([5a0153c](https://github.com/lokalise/i18n-ally/commit/5a0153c56b899ad897a0209ddfc837dabe20984c))
* config for display language ([427c206](https://github.com/lokalise/i18n-ally/commit/427c2069206dd06de3c7a5b7df404124f8086ccf))
...
* **config:** new config defaultNamespace, close [#438](https://github.com/lokalise/i18n-ally/issues/438) ([282287a](https://github.com/lokalise/i18n-ally/commit/282287a2216521ff711d57d67072894e96d8aa1e))
* **config:** new config to turn of review in gutters ([8e75030](https://github.com/lokalise/i18n-ally/commit/8e75030234a4cbce4678cfcfafb95d39f7cffee1))
...
* copy i18n key ([ebdec94](https://github.com/lokalise/i18n-ally/commit/ebdec948679f3af4cebb3363b0bcc13bb4344c01))
* coverage ([f8a80ff](https://github.com/lokalise/i18n-ally/commit/f8a80ffd102729c19c9c4305db78210aecbb35ba))
* custom refactor templates ([2812dbf](https://github.com/lokalise/i18n-ally/commit/2812dbf80c7aec0e74dda130068d64f965a871af))
* delete keys that are not in use ([c535293](https://github.com/lokalise/i18n-ally/commit/c535293d668ea48a76ebf0e2dd77ca83f45a297d))
* departed file translator ([3caaec6](https://github.com/lokalise/i18n-ally/commit/3caaec6f02cd35fd913ce2c8189827092a4bf4d1))
...
* **detect:** support different types of format ([cfc490d](https://github.com/lokalise/i18n-ally/commit/cfc490da157623abe81d942752d0d274472add3c))
* display gutter icon for missing translation in locales ([cfa0a04](https://github.com/lokalise/i18n-ally/commit/cfa0a042fb0bc309ad7d77a8d1d7cc74d7197c8f))
* displaying object keypaths ([ffea7ed](https://github.com/lokalise/i18n-ally/commit/ffea7edb6885d6a6fa0b01b3ee3be74ff479881b))
* displayLocale options ([6da2b68](https://github.com/lokalise/i18n-ally/commit/6da2b68147b62a5906ed0a1542569b6255bae1ec))
* do not display transCenter menu if the extension is not actived ([2789def](https://github.com/lokalise/i18n-ally/commit/2789def7f63e0b7752e8a2e0f0d8d2fd8d28b9b0))
* do not override existing text by default ([946ecd0](https://github.com/lokalise/i18n-ally/commit/946ecd0caee908452699f309460186c3924dd926))
* edit and goto for node ([9e6dbdc](https://github.com/lokalise/i18n-ally/commit/9e6dbdcfbfd99c74c99769b7d143aaad246835b8))
* edit in hover ([2ba3292](https://github.com/lokalise/i18n-ally/commit/2ba32925e3044005fa933415ad5ab3252140420c))
* edit keys in sidebar ([bfd3c83](https://github.com/lokalise/i18n-ally/commit/bfd3c83d0e3db7fa9d5e384eb5b523c8cb68ec1a))
* edit review comments ([1a77138](https://github.com/lokalise/i18n-ally/commit/1a771381dcceb55c07d6e739eac855624c3e313d))
* editable for shadow keys ([1e02464](https://github.com/lokalise/i18n-ally/commit/1e02464989028e416cf673444d41b1e26c85fbcf))
* **editor:** batch translating ([a0fc8c7](https://github.com/lokalise/i18n-ally/commit/a0fc8c7b5d6fbb1dfcecb60e0e944ddf53195189))
* **editor:** navigating ([ebc9dde](https://github.com/lokalise/i18n-ally/commit/ebc9dde3b10b2016732936044d87d722b773122e))
* **editor:** support for translation candidates ([03f54e8](https://github.com/lokalise/i18n-ally/commit/03f54e8dbac5140f9f01966339b215fbc36b8224))
* **ember:** support for hbs files ([2a47963](https://github.com/lokalise/i18n-ally/commit/2a47963790ec46848dec8a09740cb45b4c73975a))
* **ember:** update ember regex, by [@mamiller93](https://github.com/mamiller93), close [#448](https://github.com/lokalise/i18n-ally/issues/448) ([ec2a123](https://github.com/lokalise/i18n-ally/commit/ec2a12394cdc4968d76cadf9fda3c60ee173f04a))
...
* extract text ([3a9e000](https://github.com/lokalise/i18n-ally/commit/3a9e0001ba035d904ab896ab55039a5b8d5761ed))
* extract text from command palette, fix [#309](https://github.com/lokalise/i18n-ally/issues/309) ([8b78127](https://github.com/lokalise/i18n-ally/commit/8b7812785cd9e335e86d45fafb3295577aa24113))
...
* file locales tree displays on both view containers ([a6c07a7](https://github.com/lokalise/i18n-ally/commit/a6c07a759c7f50e4bae3a9c1051852d94da6f77d))
* find all references ([c5248d4](https://github.com/lokalise/i18n-ally/commit/c5248d49f3c91f021631f2c23cde7b8edb966260))
...
* **framework:** add ngx-translate support ([652ce69](https://github.com/lokalise/i18n-ally/commit/652ce6981e67864747a256d63c1073f0b2305df9))
* **framework:** support for ember.js, close [#135](https://github.com/lokalise/i18n-ally/issues/135) ([3f91f07](https://github.com/lokalise/i18n-ally/commit/3f91f0747f558794c53f65204c1f31d7ddeae5a9))
* **framework:** support for flutter ([6ad5d8e](https://github.com/lokalise/i18n-ally/commit/6ad5d8ed07959a3f55de1b987ab74e5edd36044f))
* **framework:** support for Laravel ([3f50900](https://github.com/lokalise/i18n-ally/commit/3f50900df867f0eb1ee26d4d1143f06043aa790d))
* fullfill keys cross all locales ([8c1734c](https://github.com/lokalise/i18n-ally/commit/8c1734c0f1c98793953f98b9e65a8ba3b7127f77))
* go to file ([19617e2](https://github.com/lokalise/i18n-ally/commit/19617e27c206c27d2d6006387773f04be530aa16))
* goto definition ([01d953c](https://github.com/lokalise/i18n-ally/commit/01d953cd0f7d76f32c091e8e70847a90b36c3cda))
* goto file for locale ([9283e5f](https://github.com/lokalise/i18n-ally/commit/9283e5f19f604782dcd16e399e06561051b48486))
...
* hide translate button for source record ([65f4fb9](https://github.com/lokalise/i18n-ally/commit/65f4fb9509ad4afec758a2016358e37f238061a9))
* hide/show locales ([71d7777](https://github.com/lokalise/i18n-ally/commit/71d777731f6cda81d9f8cefc0987963263481214))
* hover for annotation in locale ([e4e9d6d](https://github.com/lokalise/i18n-ally/commit/e4e9d6d2a8cb46b66a21c559d01afa2d8d64f146))
* **i18next:** support `/` as namespace delimiter, close [#425](https://github.com/lokalise/i18n-ally/issues/425) ([433d673](https://github.com/lokalise/i18n-ally/commit/433d673ca2256f267ddb96d6a3ef5bc057b050ab))
* **i18n:** vscode menu i18n (zh-cn) ([95447cf](https://github.com/lokalise/i18n-ally/commit/95447cffd535aab430a631372c272f6451ea9973))
* icon for tree view ([3f9419f](https://github.com/lokalise/i18n-ally/commit/3f9419f4b6cd51b33b46e5795a255162b2d4c43f))
...
* improve auto completion, thanks [@erickhcs](https://github.com/erickhcs) ([47895f9](https://github.com/lokalise/i18n-ally/commit/47895f96b39083aff1bc371e2c1e8c3bbce61612))
* improve DX for natural language keys ([c9cd232](https://github.com/lokalise/i18n-ally/commit/c9cd2326c5106c7be2c6ec88db32efef66e154fc))
* improve extracting command ([2bd4855](https://github.com/lokalise/i18n-ally/commit/2bd4855a4071370bcafdd44ba5951d64a364e9cf)), closes [#369](https://github.com/lokalise/i18n-ally/issues/369)
* improve translating experience ([29e79e8](https://github.com/lokalise/i18n-ally/commit/29e79e86dc9e1c2c66479bd37fd7a78348169f80))
* improved usage report ([6c51981](https://github.com/lokalise/i18n-ally/commit/6c51981fe049cb5dd87aa347ddf0dd5573b84cd5))
* indicators of translation missing ([51fcb2a](https://github.com/lokalise/i18n-ally/commit/51fcb2aca2944dcb19b26aa415a42c67540cfd92))
* introduce new config "vue-i18n-ally.readonly" ([465abb7](https://github.com/lokalise/i18n-ally/commit/465abb712fa1622e8c17f3bdfc30d7b53e9e552e))
* introduce php parser ([2510faa](https://github.com/lokalise/i18n-ally/commit/2510faa88f02129b44cf615df40905a852717266))
* keep source locales on top ([53531d6](https://github.com/lokalise/i18n-ally/commit/53531d67ed28f91707d86da45e4cc01048bfc08f))
* key underline ([bc48175](https://github.com/lokalise/i18n-ally/commit/bc481753ea75ad3dc2a8e50c812a4bcb98e23a8b))
...
* Lightbulb will recommend using existing translations that match if any are found antfu[#326](https://github.com/lokalise/i18n-ally/issues/326) ([#331](https://github.com/lokalise/i18n-ally/issues/331)) ([f4e1e88](https://github.com/lokalise/i18n-ally/commit/f4e1e88a372f4b37474e55045b4df79f452eaab2))
...
* load namespace ([99563d1](https://github.com/lokalise/i18n-ally/commit/99563d1826fe0001723985677bd85c31b8125e10))
* local changes now update to tree view ([4fc0eb1](https://github.com/lokalise/i18n-ally/commit/4fc0eb114bd6bafd9b0771487d8e2fd68a0aab21))
* locale flag! ([cdb3f9a](https://github.com/lokalise/i18n-ally/commit/cdb3f9ac76db0133cbb4af8b0e65d1a829514bc5))
* locale parsers will now be enabled base on framworks ([a1e9213](https://github.com/lokalise/i18n-ally/commit/a1e92134005c672ac8d5108b7801c89ceb02ce9e))
* locale tree for current file ([576d333](https://github.com/lokalise/i18n-ally/commit/576d333e473e9d6a4275f7e6152d7242af0671b3))
* machine translate api ([5b98a45](https://github.com/lokalise/i18n-ally/commit/5b98a45ddf7b029ca8d764d7927dde01ec8337a0))
* machine translate for all locales of an i18n key ([ad08c81](https://github.com/lokalise/i18n-ally/commit/ad08c81821e039ae3482dd1bc2386944565b9532))
* make hover button icon ([e0d3957](https://github.com/lokalise/i18n-ally/commit/e0d3957b2b5ea77d2f96cce4f2dbb56c548c12cb))
* match transCenter with editor style ([b2d675f](https://github.com/lokalise/i18n-ally/commit/b2d675f1e22d106b6c00ff269da44246620c76a8))
* migration notification ([81445b0](https://github.com/lokalise/i18n-ally/commit/81445b02254c0181371ce7284351e21ee4817854))
* minor improves in [#231](https://github.com/lokalise/i18n-ally/issues/231) ([c6a6c61](https://github.com/lokalise/i18n-ally/commit/c6a6c61cd0162e736b5787d9c2f4baa67a96fb5c))
* more forgiving html parser ([b1409bc](https://github.com/lokalise/i18n-ally/commit/b1409bc0652d4fe09e0b10031086ebe400b2918b))
* navigate to key ([12691ff](https://github.com/lokalise/i18n-ally/commit/12691ff0dfb7ed29af0cc9cf4b77df6dcf98cc6e))
...
* new command "duplicate key", [#137](https://github.com/lokalise/i18n-ally/issues/137) ([8aeb217](https://github.com/lokalise/i18n-ally/commit/8aeb217362dc576e86e1c859b72db070eb41b8e1))
* new command "new key", [#137](https://github.com/lokalise/i18n-ally/issues/137) ([20e09f2](https://github.com/lokalise/i18n-ally/commit/20e09f2db7548adf6c11b75a6566fb364b80057d))
...
* new config "derivedKeyRules" ([8118a53](https://github.com/lokalise/i18n-ally/commit/8118a5398fcc6f1678c8e2fddc4c2865725c0146))
* new config "fullReloadOnChanged" ([4a931e7](https://github.com/lokalise/i18n-ally/commit/4a931e75ced8d2b33f2849bed61f2cb79589c82c))
* new config "i18n-ally.ignoreFiles" ([674618b](https://github.com/lokalise/i18n-ally/commit/674618b2c113362e363eb5d22482ad9633744c85))
* new config "i18n-ally.translate.parallels" ([98ad9ee](https://github.com/lokalise/i18n-ally/commit/98ad9ee7307ce320d51d0db31e783847019c7fb8))
* new config "i18n-ally.translate.services" ([d87a4ba](https://github.com/lokalise/i18n-ally/commit/d87a4babeb145c322569355771a3b9e86f33bca6))
* new config "i18n-ally.usage.scanningIgnore" ([32ec1b5](https://github.com/lokalise/i18n-ally/commit/32ec1b58f701acf924ca5e702ca671e2e5a88dd5))
* new config "indent" and "tabStyle", [#138](https://github.com/lokalise/i18n-ally/issues/138) ([37e1ec9](https://github.com/lokalise/i18n-ally/commit/37e1ec9149e55be6c444554beb86c5d10f0aa672))
* new config "keepFulfilled" ([7780ede](https://github.com/lokalise/i18n-ally/commit/7780ede17682d90a7663956b54106cbf886afabe))
* new config "keystyle" ([216b52b](https://github.com/lokalise/i18n-ally/commit/216b52b398b6077ec9e6b1b5f2b4bb18bc022a8c))
* new config "vue-i18n-ally.sortKeys" to sort keys in JSON/YAML ([3b4dfb1](https://github.com/lokalise/i18n-ally/commit/3b4dfb1671a40826b9fac9a83db317781b6564af))
* new config `i18n-ally.refactor.templates`, resolve [#291](https://github.com/lokalise/i18n-ally/issues/291) ([1310ca0](https://github.com/lokalise/i18n-ally/commit/1310ca00b2c1e6f2f93eedb3e5ea23fc22022611))
* new config and command "keysInUse" ([395f016](https://github.com/lokalise/i18n-ally/commit/395f01655a1760fce072ac01d1205a94765edace))
* new config disablePathParsing ([7a1b812](https://github.com/lokalise/i18n-ally/commit/7a1b812df6647c27bbfbc97c862a819b453bc999))
* new config fileNamespace ([f4bdb97](https://github.com/lokalise/i18n-ally/commit/f4bdb97e85aa812ac2570b6daad27475c8590520))
* new config for customize the delimiter of annotations ([4dd8eeb](https://github.com/lokalise/i18n-ally/commit/4dd8eeb47b342a5cc281f59f8d156cd1f632f91d))
* new config keyMatchRegex ([0f3934b](https://github.com/lokalise/i18n-ally/commit/0f3934b04142a2c3f67d2f6ba05b0dcfe37acef1))
* new config parserOptions ([7a1adb9](https://github.com/lokalise/i18n-ally/commit/7a1adb976babfa0f5f20574a6086f1ac061399ec))
* new config to disable flags, [#313](https://github.com/lokalise/i18n-ally/issues/313) ([5b5c181](https://github.com/lokalise/i18n-ally/commit/5b5c181dbe9c57d273f5970d5898816a4aa7b7fe))
* new configs ([1ab0b01](https://github.com/lokalise/i18n-ally/commit/1ab0b01ddd0f69061c4f14acd70504cec4fd15e8))
* new configs for es paser ([00c1ec8](https://github.com/lokalise/i18n-ally/commit/00c1ec8bf6bdb6a553b40c12e58d1874accfc7ea))
* new configs for translating ([55d3c27](https://github.com/lokalise/i18n-ally/commit/55d3c2762dad0c38dc166e11d5f4be11ef6afc4a))
* new disabled setting ([181faa4](https://github.com/lokalise/i18n-ally/commit/181faa471ebc67065a3eeae0888c80902c847df3))
* new engine ([574b3f7](https://github.com/lokalise/i18n-ally/commit/574b3f73996b84d0c5853b8e921889d7e9afdaa9))
* new engine for completion ([83a8813](https://github.com/lokalise/i18n-ally/commit/83a8813e6ca96f2b7a79050863e15f69214c80de))
* new file loading engine ([b6a0dd0](https://github.com/lokalise/i18n-ally/commit/b6a0dd00e346afee662f0557e49e707f986a246c))
* new framework chrome-ext ([fe6839d](https://github.com/lokalise/i18n-ally/commit/fe6839d5d2198476d1b2d4adc8adda07a006b9b6))
...
* New javascript/typescript locale parser ([#243](https://github.com/lokalise/i18n-ally/issues/243)) ([c63e404](https://github.com/lokalise/i18n-ally/commit/c63e40431b5cc73adf7261acd045194942ea1221))
* new js/ts loader, resolve [#97](https://github.com/lokalise/i18n-ally/issues/97) ([f363111](https://github.com/lokalise/i18n-ally/commit/f36311139b95206365da060a978867a459edabdf))
* new logo ([8b58396](https://github.com/lokalise/i18n-ally/commit/8b58396536a838c2ff02c1fbdfa3254edbac7ce7))
* new option "languageTagSystem", resolves [#256](https://github.com/lokalise/i18n-ally/issues/256) ([f0231d2](https://github.com/lokalise/i18n-ally/commit/f0231d280274d27c322a16aef0c3a94855a1d1a9))
...
* new options "promptTranslatingSource" ([71b1606](https://github.com/lokalise/i18n-ally/commit/71b16067a2462b453970c7fcdec19c9baa3548e2))
* new options enabledParsers ([905cebb](https://github.com/lokalise/i18n-ally/commit/905cebbd1810f4a8797fd9e9b83e8b7539ce7197))
* new progress bar ([f1f77e3](https://github.com/lokalise/i18n-ally/commit/f1f77e3cf45498faaabba5511a6199dca3644872))
* new setting field "vue-i18n-ally.preferredDelimiter" ([96030d4](https://github.com/lokalise/i18n-ally/commit/96030d4ec2c3854182c4de7a6c7fdc9bf6962dc5))
* **next-translate:** support next-translate, resolve [#295](https://github.com/lokalise/i18n-ally/issues/295) ([59a8c15](https://github.com/lokalise/i18n-ally/commit/59a8c1576b6e096f11d8bc64953cabc6b411d88d))
* **ngx-translate:** add new usage, reslove [#333](https://github.com/lokalise/i18n-ally/issues/333) ([b7481d7](https://github.com/lokalise/i18n-ally/commit/b7481d7428baea0c4eeac9848ee1ba75317ddbd0))
...
* open editor keypath selecting ([f5f86e5](https://github.com/lokalise/i18n-ally/commit/f5f86e51b22b6955df279d2fc7940af7ebde2a50))
* open key in editor from tree view ([46804b3](https://github.com/lokalise/i18n-ally/commit/46804b36541092c6075f118006f04b6630bd6278))
* open review in hover ([a1e4a55](https://github.com/lokalise/i18n-ally/commit/a1e4a5598cdf8f438cf007776bab5a09e793d7a9))
* **parser:** supporting JSON5 ([46af841](https://github.com/lokalise/i18n-ally/commit/46af841ce4ec3f4b165c9158670df0be6bed4370))
* **parser:** YAML support  🎉 ([e71c6ac](https://github.com/lokalise/i18n-ally/commit/e71c6acc566f8d9925c5d8b67a4a0476267d89c8))
* path matcher parser ([3b4ff43](https://github.com/lokalise/i18n-ally/commit/3b4ff43e922e2db1cf4fbbf8b751f077f7ce2cf1))
* **pathMatcher:** new macther `{namespace?}` and `{namespaces?}` ([22c346e](https://github.com/lokalise/i18n-ally/commit/22c346ed1c85ef5683ffdc0af44788d522ca1c60))
* **polyglot:** new framework polyglot ([040b671](https://github.com/lokalise/i18n-ally/commit/040b6718b0a71eb4812bb261cd039badda6a497c))
* pot parser ([3dce5ab](https://github.com/lokalise/i18n-ally/commit/3dce5abbb217f16f4832eec1ea569634c4d4f21b))
...
* progress bar ([2424f4a](https://github.com/lokalise/i18n-ally/commit/2424f4adfa413f911081975418d65639236253cf))
* progress report for translating ([f0c4908](https://github.com/lokalise/i18n-ally/commit/f0c49083441608cb882ddb46a373ac427d20f9c2))
* prompt on multiple translating ([447b391](https://github.com/lokalise/i18n-ally/commit/447b391d8bca2be1e7e2c1d40a39cd78c4b5ad7b))
* quick fix ([a229118](https://github.com/lokalise/i18n-ally/commit/a22911899089f9766b4d0310eb5238b3ea23fe30))
...
* **react:** formatMessage & useIntl ([2893f4e](https://github.com/lokalise/i18n-ally/commit/2893f4e6e9dbb7566350078a2d513a10b807c391))
* **react:** support <Trans> tag detection, close [#423](https://github.com/lokalise/i18n-ally/issues/423) ([dbf4fde](https://github.com/lokalise/i18n-ally/commit/dbf4fde382ace876f0cda54fec3d144261e00328))
* real tree view ([b88484e](https://github.com/lokalise/i18n-ally/commit/b88484ecf0d3f12ba79a8b0015e121c51c0b8835))
...
* refactor to rename ([1c556fb](https://github.com/lokalise/i18n-ally/commit/1c556fb4705109bc85070e38a47f2aac6b935c39))
* remove the placeholder for empty value ([d094484](https://github.com/lokalise/i18n-ally/commit/d094484bc5f6a2c144b30f07f2ce8645d665ecdd))
* rename keys ([6c24567](https://github.com/lokalise/i18n-ally/commit/6c245676f8406acae83710e102b6134a91dfbbe1))
* review comments in code ([6a401d9](https://github.com/lokalise/i18n-ally/commit/6a401d95e0dfa099135546bf6c8cea7943f49a36))
* review on sidebar ([3761dbc](https://github.com/lokalise/i18n-ally/commit/3761dbc74e169a98913c8f1a1d2399d857078bc9))
* **review:** apply suggestions ([cdae3d7](https://github.com/lokalise/i18n-ally/commit/cdae3d7af0b251d5e61ce5a22ad443bc31366c80))
* **review:** comment api support ([ab3ab7d](https://github.com/lokalise/i18n-ally/commit/ab3ab7d79afafc11ab7e0d7d36db281e1e443c93))
* **review:** gutters display ([2428798](https://github.com/lokalise/i18n-ally/commit/2428798066042968df9183110c7c58426e9bc391))
* SAP UI5 Framework support ([#288](https://github.com/lokalise/i18n-ally/issues/288)), thanks [@mahesh0431](https://github.com/mahesh0431) ([98faaf5](https://github.com/lokalise/i18n-ally/commit/98faaf543a7c0d62074d9fac2eab0cb750992c2a))
* scope range for frameworks, resolves [#246](https://github.com/lokalise/i18n-ally/issues/246) ([5ad98f1](https://github.com/lokalise/i18n-ally/commit/5ad98f1f06bbe53fd2b95436b0477b3c9228ffdb))
...
* **sfc:** sfc works in readonly mode ([b5d7c0c](https://github.com/lokalise/i18n-ally/commit/b5d7c0c5185e79925c4c0c59ae1af76213e5ba38))
* shadow locale records ([433312c](https://github.com/lokalise/i18n-ally/commit/433312ce87f094694f6e657a9201e9d1b64d8a1d))
* show missing keys in "problems" section ([f1bc61e](https://github.com/lokalise/i18n-ally/commit/f1bc61e181b4563c5177bdaf69a260e45f11bb3f))
* show non-existent keys in file tree ([4a49bda](https://github.com/lokalise/i18n-ally/commit/4a49bda0d8ab36914e8abac6af903f9d6e837497))
* sidebar for editor ([6b5bd72](https://github.com/lokalise/i18n-ally/commit/6b5bd728c9cab4a3b3e3b738cfa3f5b9cbb9a7d9))
* sort keys ([a5de710](https://github.com/lokalise/i18n-ally/commit/a5de710421878d85f945d821eac02e5e5ea11ca6))
* source and displaying locales indicator ([6e93964](https://github.com/lokalise/i18n-ally/commit/6e93964ea84fa005af65667437028a41dcf09abc))
* special "unicode font" for displaying locales ([05da0ef](https://github.com/lokalise/i18n-ally/commit/05da0efdbdf1a91704e91ff5952c9f4d395f81c3))
* status bar language switch, close [#91](https://github.com/lokalise/i18n-ally/issues/91) ([a83d677](https://github.com/lokalise/i18n-ally/commit/a83d6778fcdf1a2c4a53ee3c8a1952196de62681))
...
* support colon for i18next ([388cd2e](https://github.com/lokalise/i18n-ally/commit/388cd2ef5eccc99985272ad21b759c5917ad967d))
...
* support custom framework config! ([37305d8](https://github.com/lokalise/i18n-ally/commit/37305d833afd1091cf9cc851df2dfa7609804bdb))
...
* support for annonation in json locale files! ([43dbe52](https://github.com/lokalise/i18n-ally/commit/43dbe52133b48f6fec047ff9139c812c684d5d60))
* support for custom match regex ([dd1d65b](https://github.com/lokalise/i18n-ally/commit/dd1d65be12c42631000e3eb9e7a4ad5eef3f144d))
* support for ejs ([3971011](https://github.com/lokalise/i18n-ally/commit/3971011306ce6167a05a6f5b0d5eec01f6022556))
* support for flatten style, [#25](https://github.com/lokalise/i18n-ally/issues/25), thanks @JJBocanegra ([93f5432](https://github.com/lokalise/i18n-ally/commit/93f54329943d79c8dacc2990ae5066fd148d05b7))
* support for i18n-tag ([fb37acb](https://github.com/lokalise/i18n-ally/commit/fb37acb7e7f1a3c08436d2edc9fbef6df065f0ba))
* support for joomla ([3859fe4](https://github.com/lokalise/i18n-ally/commit/3859fe48b9e0ab602fc871662f87a4d40fec6423))
* support for rails i18n ([544056a](https://github.com/lokalise/i18n-ally/commit/544056a76aa7188ce39c59f603698bc8cde74ee6))
* support general i18next ([b23bd33](https://github.com/lokalise/i18n-ally/commit/b23bd332a4c22b456364ceb935f41b5fb23f8189))
...
* support linked locale messages, [#147](https://github.com/lokalise/i18n-ally/issues/147) ([c2856e3](https://github.com/lokalise/i18n-ally/commit/c2856e32d8dd2837fba02b7372cc386fc2c7502e))
* support multiple encodings, thanks [@mudoo](https://github.com/mudoo) ([#105](https://github.com/lokalise/i18n-ally/issues/105)) ([a23cc7a](https://github.com/lokalise/i18n-ally/commit/a23cc7a6b506b7473417ccc9f41bfa39d76edc7e))
* support namespace scope for i18next, resolve [#307](https://github.com/lokalise/i18n-ally/issues/307) ([e89557c](https://github.com/lokalise/i18n-ally/commit/e89557c638b0115de043b63bcce58f2ea1d4b4c0))
...
* support wildcard for `keysInUse`, close [#391](https://github.com/lokalise/i18n-ally/issues/391) ([6929cd0](https://github.com/lokalise/i18n-ally/commit/6929cd0960ad6170f52676fd4b8956494cbeb8d6))
* **svelte:** new framework svelte ([926e83d](https://github.com/lokalise/i18n-ally/commit/926e83d783a37906c783859e6e9dcc00827f7915))
* **tagSystem:** `none` will try to parse bcp47 for flag icons now ([7cef0ed](https://github.com/lokalise/i18n-ally/commit/7cef0ed5f01fcf001b63da216519045eb9123aa5))
* transcenter ([ffd2b71](https://github.com/lokalise/i18n-ally/commit/ffd2b712617b6fa35d039210e08f95ff5376d8d7))
* transCenter，显示i18n路径 ([7418c6a](https://github.com/lokalise/i18n-ally/commit/7418c6abc095a86473dfb1e61187dbc101050d28))
* translate all missing keys ([940fe20](https://github.com/lokalise/i18n-ally/commit/940fe20628d41da416db334c48aca5e437ed4669))
* translate only specific locales ([54f82e5](https://github.com/lokalise/i18n-ally/commit/54f82e583d305e58026f4ff628d9c690e48221c8))
* translate single locale ([935a8d8](https://github.com/lokalise/i18n-ally/commit/935a8d891c9fbcd5a9b38fdee77ea8259586e2ab))
* translating for records listed under progress view ([29413dd](https://github.com/lokalise/i18n-ally/commit/29413dd3dedea5208b6293b402ae7ab8ea4ab1b7))
* translation candiates batch apply ([1ebd689](https://github.com/lokalise/i18n-ally/commit/1ebd6898df98eb5d0e30d75ff724367a4c1a7837))
* translation candidate system ([8c44c3f](https://github.com/lokalise/i18n-ally/commit/8c44c3f849505a2baf6ed917878361341968c4d7))
* translation indicator ([4fcd3cf](https://github.com/lokalise/i18n-ally/commit/4fcd3cf3015ceb51a58f108cd97be1f47c5df3e1))
* translation notification ([497e8c8](https://github.com/lokalise/i18n-ally/commit/497e8c8fa7151a8de48677ff5285b541b09e2d34))
* **translations:** add missing NL translations ([3bcd79f](https://github.com/lokalise/i18n-ally/commit/3bcd79fc6d57251a66f56d5b092e2158de78863c))
* **transloco:** add html parser ([6c9577c](https://github.com/lokalise/i18n-ally/commit/6c9577cd43cc39d82c954a00eb43e208b755887d))
* **transloco:** new framework support ([14a3b18](https://github.com/lokalise/i18n-ally/commit/14a3b181caa8ea0ce709f14a0c17293f1263cee1))
* tree view expandable ([800c53e](https://github.com/lokalise/i18n-ally/commit/800c53e6c616e02adb684bd24a6e94c64de39ed4))
* ui improves ([423d269](https://github.com/lokalise/i18n-ally/commit/423d269692127e35855f7aafab3f0f727d54f0a0))
...
* update vue-i18n match regex ([9da2a6d](https://github.com/lokalise/i18n-ally/commit/9da2a6d31d20f26753a8635dbf0580f69970d421))
* usage report ([5be18e2](https://github.com/lokalise/i18n-ally/commit/5be18e2e6a79740a9a903b9d46fa80f4e1269ae4))
...
* use table to display hint ([0534a20](https://github.com/lokalise/i18n-ally/commit/0534a20489aa7c586055ea5fa51a27b10670d611))
* vscode sidebar ([95c107f](https://github.com/lokalise/i18n-ally/commit/95c107ffcd1da1438ac870e7b952713999f77d2b))
* **vscode:** support annonation in package.json ([0e4086b](https://github.com/lokalise/i18n-ally/commit/0e4086ba639e5e35228371a32b15d3893289ed59))
...
* wath on file change ([17f0113](https://github.com/lokalise/i18n-ally/commit/17f0113e16683cfc23f7ea20618f5ebde17cac6d))
* workspace support ([eea0eb3](https://github.com/lokalise/i18n-ally/commit/eea0eb395ce411519c9ebd327ec20c790b226de6))
* write to namespaces ([7359430](https://github.com/lokalise/i18n-ally/commit/73594301ceb5ae530ebcbf0184de9f081caf4c45))
* writing for new engine ([e3ed487](https://github.com/lokalise/i18n-ally/commit/e3ed4875ffa3daf047bba441e262f6d72e2d8b91))
* writing for SFC ([7acb628](https://github.com/lokalise/i18n-ally/commit/7acb6280b837e3e9d051558adf58812ebf3aec6f))
* yaml annotation support ([d351079](https://github.com/lokalise/i18n-ally/commit/d351079844acd1109b51920aa0ddd7bfacd3b98d))
...
* 防止多次提示初始化 ([db1d0dc](https://github.com/lokalise/i18n-ally/commit/db1d0dcc4881abf46ae3f84d4b0c9a4a85764176))
* 覆盖提示取消无效 ([9575793](https://github.com/lokalise/i18n-ally/commit/957579373e91ffee52d259d3cc30127564303093))
* 根据标准声明scheme ([bd1d8c2](https://github.com/lokalise/i18n-ally/commit/bd1d8c24636ee586cba2655e7526e15b5e9e5392))
* 默认key，减少key的层级 ([e7523e9](https://github.com/lokalise/i18n-ally/commit/e7523e926721639ff9237dc354d6800f8cfe3049))
* 默认key，引用文件时无法处理带-的命名，所以转义一下-为驼峰 ([65b6519](https://github.com/lokalise/i18n-ally/commit/65b6519afb6b2036b64103076e5cd343bd29826a))
* 只响应有 vue-i18n 依赖的项目 ([78c24a6](https://github.com/lokalise/i18n-ally/commit/78c24a63bcecd408d6cf595c4a8d1fa87a494a86))
* 中文注释，提取翻译后没有及时更新内容 ([0f29782](https://github.com/lokalise/i18n-ally/commit/0f29782b7474c421879fa96b1ec535b90b722dd1))
...
* change problem severity to infomation ([8b25e4f](https://github.com/lokalise/i18n-ally/commit/8b25e4f1f8e53eb8ba4adaefa4661463789c58fd))
...
* error log app name ([82c460f](https://github.com/lokalise/i18n-ally/commit/82c460f035112687af8f73d52e509e529fb3760d))
...
* typing errors ([56216a0](https://github.com/lokalise/i18n-ally/commit/56216a05d669aa320f37909f75b3b6e9c3151f1f))
* typo ([9877490](https://github.com/lokalise/i18n-ally/commit/98774907c1331dc52c3f976e99c8ec9e7aefae2e))
* typo ([739f4b3](https://github.com/lokalise/i18n-ally/commit/739f4b3b016a7594c2fadba50458580cb4e8155b))
* typo ([ac95455](https://github.com/lokalise/i18n-ally/commit/ac9545551644cd036f7345d41973fe154a1e28a6))
* typo ([41c076f](https://github.com/lokalise/i18n-ally/commit/41c076fa660b5606331e84c9d5058fd5d540c8ed))
...
* unexpected supported locales bug, resolve [#30](https://github.com/lokalise/i18n-ally/issues/30), thanks [@acbetter](https://github.com/acbetter) ([42f4a44](https://github.com/lokalise/i18n-ally/commit/42f4a44c16e5c886c2c2e51b1c983a9fa0a3eda6))
* update analyst cache on file changed ([7114b0d](https://github.com/lokalise/i18n-ally/commit/7114b0da409929ae8e7f26b66cbeeb33a922bd08))
...
* use emoji for hover buttons, [#121](https://github.com/lokalise/i18n-ally/issues/121) ([a43c18f](https://github.com/lokalise/i18n-ally/commit/a43c18f880e461ead51e00a21a9805651f842e3d))
...
* vscodeignore ([cfa90e4](https://github.com/lokalise/i18n-ally/commit/cfa90e4d94d7756d837a24d77a04cd953c2d4ea5))
* **vscode:** locale fallback ([c383d85](https://github.com/lokalise/i18n-ally/commit/c383d856d43404c1258f6ed2778b3b9c5a1e81a2))
...
* vue sfc loader locale normalize ([dcd59c8](https://github.com/lokalise/i18n-ally/commit/dcd59c8e3654bb5093e357789529370fd1219a76))
...
* vue-sfc ([46ab268](https://github.com/lokalise/i18n-ally/commit/46ab268a57229e1d87d8ed33d9c24776591aa491))
* **vue:** remove $d and $n support, resolves [#254](https://github.com/lokalise/i18n-ally/issues/254) ([267ca5a](https://github.com/lokalise/i18n-ally/commit/267ca5acdc16010ca09d024c52ac55980de1d07e))
* **vue:** support annonation on jsx and tsx ([595ec5c](https://github.com/lokalise/i18n-ally/commit/595ec5c6bfb227420ba21a720a91d87f68eec3d9))
* vuex-i18n fixture ([6687a72](https://github.com/lokalise/i18n-ally/commit/6687a7202b98f4ba499b93c70f867773527379a1))
* warning for no locale file loaded ([768a4d2](https://github.com/lokalise/i18n-ally/commit/768a4d27d912003b08a8bff4cf01622ef2f1610e))
* watcher on dir locales mode, resolve [#97](https://github.com/lokalise/i18n-ally/issues/97) ([7b26c52](https://github.com/lokalise/i18n-ally/commit/7b26c523f0337617b4e593c983a296509d7c3bf1))
* webpack build ([f603d02](https://github.com/lokalise/i18n-ally/commit/f603d02978e8a7045ccda47226afdcc5cd67f67a))
* Write file with newline at the end of file ([#225](https://github.com/lokalise/i18n-ally/issues/225)) ([ad9a7ac](https://github.com/lokalise/i18n-ally/commit/ad9a7ac1582f06be83eee9ba5657fa3399bb4676))
* wrong annonation position for single letter keypath, [#178](https://github.com/lokalise/i18n-ally/issues/178) ([d982dd3](https://github.com/lokalise/i18n-ally/commit/d982dd35bf4b03fa5e1730e429603064a1ed8dea))
* zh-cn 放在顶部方便输入 ([bf2d121](https://github.com/lokalise/i18n-ally/commit/bf2d1218639716959f0f21a76175792bbdb29924))
