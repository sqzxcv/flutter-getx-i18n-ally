...
export class Reviews {
  ...
  init(rootpath: string) {
    ...
    this.filepath = path.join(rootpath, '.vscode/flutter-getx-i18n-ally-reviews.yml')
  ...
  private async save() {
    ...
    content = `# Review comments generated by flutter-getx-i18n-ally. Please commit this file.\n\n${content}`
